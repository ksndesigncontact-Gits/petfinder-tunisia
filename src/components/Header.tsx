...
import { PawPrint, MapPin as MapIcon, LayoutGrid, ShieldCheck, X } from 'lucide-react';
...
export default function Header({ viewMode, setViewMode, isAdmin, setIsAdmin, onLogoClick }: HeaderProps) {
  return (
